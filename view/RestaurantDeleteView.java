...
public class RestaurantDeleteView extends JFrame {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RestaurantDeleteView frame = new RestaurantDeleteView();
	...
	public RestaurantDeleteView() {
		...
		JLabel lblNewLabel = new JLabel("DELETE RESTAURANT");
		...
		txtfield_telephone.setEditable(false);
		...
		JLabel lblResto = new JLabel("Restaurants");
		lblResto.setFont(new Font("Arial", Font.BOLD | Font.ITALIC, 15));
		deliveryAreaTitle_panel.add(lblResto);
		...
		btnDeleteRestaurant = new JButton("Delete Restaurant");
		...
		JLabel lblDelivery = new JLabel("Delivery areas");
		lblDelivery.setFont(new Font("Arial", Font.BOLD | Font.ITALIC, 15));
		addRestaurantTitle_panel.add(lblDelivery);
		
		JPanel addRestaurantList_panel = new JPanel();
		addRestaurant_panel.add(addRestaurantList_panel, BorderLayout.CENTER);
		
		list_1 = new JList();
		list_1.setFont(new Font("Arial", Font.ITALIC, 16));
		...
		comboBox_26.setEnabled(false);
		comboBox_26.setPreferredSize(new Dimension(50, 20));
		comboBox_26.setEditable(false);
		...
		comboBox_27.setEnabled(false);
		comboBox_27.setPreferredSize(new Dimension(50, 20));
		comboBox_27.setEditable(false);
	 ...
	 */
	public void setTxtfield_telephone(JTextField txtfield_telephone) {
	...
	/**
	 * @return the btnDeleteRestaurant
	 */
	public JButton getBtnDeleteRestaurant() {
		return btnDeleteRestaurant;
	}


	/**
	 * @param btnDeleteRestaurant the btnDeleteRestaurant to set
	 */
	public void setBtnDeleteRestaurant(JButton btnDeleteRestaurant) {
		this.btnDeleteRestaurant = btnDeleteRestaurant;
	}
