...
//	Font font = new Font("Arial", 1, 15);
	...
	// Account Menu Bar
	JMenuItem menuItemCreateAccount;
	JMenuItem menuItemEditAccount;
	JMenuItem menuItemDeleteAccount;

	// Order Menu Bar
	JMenuItem menuItemOrderFood;
	JMenuItem menuItemOrderHistory;
	...
	public Client() {
		...
		menuItemCreateAccount = new JMenuItem("Create");
		menuItemCreateAccount.setFont(new Font("Arial", Font.PLAIN, 15));
		menuAccount.add(menuItemCreateAccount);
		...
		panel_8.add(btnOrderHistory);

		JPanel panel_9 = new JPanel();
		panel_5.add(panel_9);

		btnCreateAccount = new JButton("Create Account");
		btnCreateAccount.setBorder(new BevelBorder(BevelBorder.RAISED, Color.GRAY, null, Color.GRAY, null));
		btnCreateAccount.setFont(new Font("Arial", Font.BOLD | Font.ITALIC, 15));
		btnCreateAccount.setPreferredSize(new Dimension(275, 50));
		panel_9.add(btnCreateAccount);
	...
	/**
	 * @param btnCreateAccount the btnCreateAccount to set
	 */
