...
public class RestaurantDelete extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RestaurantDelete frame = new RestaurantDelete();
	...
	public RestaurantDelete() {
		...
		JLabel lblNewLabel = new JLabel("DELETE NEW RESTAURANT");
		...
		JButton btnDeleteRestaurant = new JButton("Delete Restaurant");
