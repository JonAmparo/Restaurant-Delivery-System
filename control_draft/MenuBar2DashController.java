...
public class MenuBar2DashController{
	...
	public MenuBar2DashController(RestaurantCreateView restoCreateView, RestaurantEditView editView, RestaurantDeleteView deleteView, AdminDash view) {
		this.restoCreateView = restoCreateView;
				
		view.getMenuRestaurant().getItem(0).addActionListener(new ActionListener() {			
			@Override
		...
		view.getMenuRestaurant().getItem(1).addActionListener(new ActionListener() {			
			@Override
			public void actionPerformed(ActionEvent e) {
				restoCreateView.getTxtfield_name().setText("");
				restoCreateView.getTxtfield_address().setText("");
		...
		view.getMenuRestaurant().getItem(2).addActionListener(new ActionListener() {			
			@Override
			public void actionPerformed(ActionEvent e) {
				restoCreateView.getTxtfield_name().setText("");
				restoCreateView.getTxtfield_address().setText("");
