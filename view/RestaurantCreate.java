...
public class RestaurantCreate extends JFrame {
	...
	public RestaurantCreate() {
		...
		btnDeleteRestaurant.setFont(new Font("Tahoma", Font.BOLD, 12));
		...
		textArea.setBorder(new LineBorder(Color.LIGHT_GRAY, 3, true));
		deliverytxt_panel.add(textArea, BorderLayout.CENTER);
