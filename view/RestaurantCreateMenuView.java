...
public class RestaurantCreateMenuView extends JFrame {
	...
	public RestaurantCreateMenuView() {
		...
		btnAdd = new JButton(new ImageIcon("button_add.png"));
		...
		itemTxt_field.setForeground(Color.WHITE);
		...
		priceTxt_field.setForeground(Color.WHITE);
		...
		JButton btnSelect = new JButton(new ImageIcon("button_select.png"));
		...
		btnNewButton = new JButton(new ImageIcon("button_create.png"));
		...
		arrow_lbl.setForeground(Color.gray);
